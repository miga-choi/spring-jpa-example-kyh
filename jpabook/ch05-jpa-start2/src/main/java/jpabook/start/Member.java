...
public class Member {
     ...
     * 예를 들어)
     * 회원과 팀 엔티티는 외래 키가 있는 다 쪽인 회원이 연관관계의 주인이 된다.
     * 물론 비즈니스 중요도를 생각해보면 팀보다 회원이 더 중요한 것 같은 느낌도 들 것이다.
     * 하지만 자동차의 차체와 바퀴를 생각해보면 바퀴가 외래 키가 있는 다 쪽이다.
     * 따라서 바퀴가 연관관계의 주인이 된다.
     * 차체가 더 중요한 것 같아 보이지만 연관관계의 주인은 단순히 외래 키를 매핑한 바퀴를 선택하면 된다.
     * 결론)
